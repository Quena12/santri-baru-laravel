...
@section('content')
    ...
    <section style="margin-top: 100px">
        <div class="container py-5 col-xxl-8 py-5">
            <h3 class="fw-bold mb-3">Halaman Dashboard Admin</h3>
            <p> Selamat Datang Di halaman Dasbhoard Admin</p>
            <div class="row">
                <div class="col-lg-4">
                    <div class="card sadhow-sm rounded-3 border-0">
                        <img src="{{asset('asset/image/kg 1.png')}}" class="card-img-top" alt="...">
                        <div class="card-body">
                            <h5 class="card-title">Blog Artikel</h5>
                            <p class="card-text">Atur dan Kelolah Atikel Kegiatan Pesantren</p>
                ...
                <div class="col-lg-4">
                    <div class="card sadhow-sm rounded-3 border-0">
                        ...
                        <div class="card-body">
                            ...
                            <p class="card-text">Atur dan Kelolah Photo Kegiatan Pesantren</p>
